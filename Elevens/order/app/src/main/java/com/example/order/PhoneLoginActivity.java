    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                loadingBar.dismiss();
                Toast.makeText(PhoneLoginActivity.this, "Please enter valid phone number with your country code.", Toast.LENGTH_SHORT).show();
            ...
            public void onCodeSent(String verificationId,
                ...
                loadingBar.dismiss();
                Toast.makeText(PhoneLoginActivity.this, "Code has been sent, check your SMS.", Toast.LENGTH_SHORT).show();
